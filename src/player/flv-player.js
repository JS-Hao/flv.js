...
class FlvPlayer {
  constructor(mediaDataSource, config) {
    ...
    this.e = {
      ...
      onvStalled: this._onvStalled.bind(this), // 媒体数据不可用时触发
    ...
    this._mediaDataSource = mediaDataSource; // 媒体数据源
    ...
    this._alwaysSeekKeyframe =
      chromeNeedIDRFix || Browser.msedge || Browser.msie ? true : false;
  ...
  load() {
    ...
    this._transmuxer.on(TransmuxingEvents.INIT_SEGMENT, (type, is) => {
      //   console.log("INIT_SEGMENT");
      this._msectl.appendInitSegment(is);
    });
    this._transmuxer.on(TransmuxingEvents.MEDIA_SEGMENT, (type, ms) => {
      //   console.log("MEDIA_SEGMENT");
    ...
    this._transmuxer.on(TransmuxingEvents.RECOVERED_EARLY_EOF, () => {
      //   console.log("RECOVERED_EARLY_EOF");
    ...
    this._transmuxer.on(TransmuxingEvents.SCRIPTDATA_ARRIVED, (data) => {
      //   console.log("SCRIPTDATA_ARRIVED");
      this._emitter.emit(PlayerEvents.SCRIPTDATA_ARRIVED, data);
    });
    this._transmuxer.on(TransmuxingEvents.STATISTICS_INFO, (statInfo) => {
      //   console.log("STATISTICS_INFO");
    ...
    this._transmuxer.on(
      ...
      (milliseconds) => {
        // console.log("RECOMMEND_SEEKPOINT");
